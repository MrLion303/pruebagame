...
if (instance_exists(obj_player))
{
    ...
    var _npc_cy = bbox_bottom; // <--- Aquí está el cambio clave: la base del NPC
    ...
    // Si el jugador está cerca de los pies, presiona la tecla Y NO hay caja de texto abierta
    if (_distance <= _interaction_distance && _interact_key && !instance_exists(obj_textbox))
    {
