...
if (instance_exists(obj_transicion_bbs)) { _fade_transicion = obj_transicion_bbs.image_alpha; }
...
if (!variable_instance_exists(id, "en_menu_inventario") || !en_menu_inventario) {
    ...
    if (en_seleccion_enemigo) {
        ...
        var _vida_act = _en_activo.vida_actual; var _vida_max = _en_activo.vida_max;
