...
if (_todos_derrotados) {
    if (variable_instance_exists(id, "musica_batalla_actual") && audio_is_playing(musica_batalla_actual)) {
...
if (draw_char < text_length) {
    ...
    if (accept_key) {
        if (en_menu_inventario) {
            ...
            // Notificar al controlador que cambie al turno del enemigo si existe
            ...
            if (opcion_seleccionada == 0) { 
                ...
                if (variable_instance_exists(id, "musica_batalla_actual") && audio_is_playing(musica_batalla_actual)) audio_stop_sound(musica_batalla_actual);
                audio_stop_sound(snd_bbs_start);
                audio_resume_all();
            ...
            if (opcion_fight_seleccionada == 0) { 
                ...
                // Activar temblor y sonido de impacto/shake
                ...
                if (_en_actual.vida_actual <= 0) {
                    ...
                    text_to_draw = "Hiciste " + string(_dano) + " de dano a " + _en_actual.nombre + "!";
                }
