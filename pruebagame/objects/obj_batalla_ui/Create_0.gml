...
// VARIABLE DE FADE OUT DE SALIDA
...
// Ya no usamos audio_pause_all() para evitar cortar el sonido de entrada (snd_bbs_start)
...
// Reproducimos la música de batalla directamente
