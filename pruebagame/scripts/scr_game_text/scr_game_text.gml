...
function scr_game_text(_text_id){
    ...
    scr_text("Hola, soy Noelle y este es mi diálogo con retrato.", c_white, spr_noelle_normal, snd_noelle);
    scr_text("Este segundo renglón tambien se acomoda solito respetando la cabeza.", c_white, spr_noelle_normal, snd_noelle);
